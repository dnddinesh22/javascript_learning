const employees = [
    ...
    { id: 2, name: 'Alice Smith', age: 28, department: 'HR', salary: 45000, speciaization: "SQL" },
...
function findEmployeeBySpecializationId(speciaizationId) {
    const foundEmployee = employees.find(employee => employee.speciaization === speciaizationId);
    if (foundEmployee) {
